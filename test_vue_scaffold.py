"""
Standalone test script for the Vue 3 project scaffolder.

This script tests the VueScaffolder implementation by creating a test project
...
# Import the VueScaffolder directly from the module
...
class TestVueScaffolder(unittest.TestCase):
    ...
    def test_package_json_content(self):
        ...
        self.assertIn('"pinia"', package_json)
