    ...
    try:
        ...
        return {
            ...
            "analysis": {
                ...
                "framework_detected": _detect_framework(deps, dev_deps) if '_detect_framework' in globals() else None,
                "build_tool": _detect_build_tool(deps, dev_deps) if '_detect_build_tool' in globals() else None
            },
            "issues": issues,
            "warnings": warnings,
...
def update_packages(
    ...
    try:
        ...
        if check_only:
            try:
                # Parse the JSON output from the outdated command
...
def register_tools(mcp):
    ...
    # Register additional tools if they exist
    if 'register_additional_tools' in globals():
