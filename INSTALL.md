...
4. Start the server:
   ...
   uv run python -m web_development_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn web_development_mcp.server:app --port 10853
   ```
5. Open `http://localhost:10853` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/web-development-mcp/issues) |
